...
if (NOT CHAT__CEREAL_ROOT)
    set(CHAT__CEREAL_ROOT ${CMAKE_CURRENT_LIST_DIR}/../3rdparty/cereal CACHE STRING "")
endif()
...
if (NOT TARGET cereal)
    ...
    target_include_directories(cereal INTERFACE ${CHAT__CEREAL_ROOT}/include)
endif()
