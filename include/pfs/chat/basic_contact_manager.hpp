...
protected:
    ...
    basic_contact_manager () = default;
    ~basic_contact_manager () = default;
    basic_contact_manager (basic_contact_manager const &) = delete;
    basic_contact_manager & operator = (basic_contact_manager const &) = delete;
    basic_contact_manager (basic_contact_manager && other) = default;
    basic_contact_manager & operator = (basic_contact_manager && other) = default;
