...
int ConversationModel::rowCount (QModelIndex const & parent) const
{
    return 0;
}

int ConversationModel::columnCount (QModelIndex const & parent) const
{
    return 1;
}

QVariant ConversationModel::data (QModelIndex const & index, int role) const
{
//     if (role < Qt::UserRole)
